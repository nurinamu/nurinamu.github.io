...
## NoSQL 과 이벤츄얼 컨시스턴시<a name="nosql"></a>
...
## 구글 클라우드 데이터스토어에서의 이벤츄얼 컨시스턴시(Eventual Consistency)<a name="nosql"></a>
...
## 엔세스터 쿼리(ancestor Query)와 엔티티 그룹(Entity Group)<a name="ancestor"></a>
...
## 엔티티 그룹(Entity Group)과 엔세스터 쿼리(Ancestor Query)의 한계들<a name="limitation"></a>
...
## 엔세스터쿼리의 대체제들<a name="alternatives"></a>
...
## 완전한 컨시스턴시 확보를 위한 시간 최소화하기<a name="minimize"></a>
